...
function LogIn() {
    const divStyle = {
        ...
        backgroundPosition: '800px 320px', minHeight:800, minWidth:500,
      };
    let navigate = useNavigate();
    return (
        //TODO: send the login request
        <div style={divStyle}>
            <header className={styles.login}> Please Log In</header>
        <Form>
        <Form.Group className={styles.t} controlId="formBasicEmail" style={{marginTop: 30}} >
